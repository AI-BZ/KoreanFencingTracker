"""
Translation Manager for Korean Fencing Tracker

Handles loading and retrieving translations from JSON files.
Supports namespaced translations (common, player, competition, etc.)
"""
...
class TranslationManager:
    ...
    def get(
        ...
        **kwargs
        ...
        Examples:
            i18n.get('common.nav.login', 'en')
            # Returns: 'Login'

            i18n.get('common.search.results_count', 'en', count=5)
            # Returns: '5 results found'
        """
    ...
    def get_all(self, namespace: str, lang: str = DEFAULT_LANGUAGE) -> Dict[str, Any]:
        ...
        Args:
            namespace: Translation namespace (e.g., 'common', 'player')
            lang: Language code
